...
**Markdown docs** — bind via `mcp__plugin_live-feedback_live-feedback__create_review_doc(docId, path, title?)`. Share the review URL (`http://mac-mini.tailb53801.ts.net:8787/review/<docId>`) in your message to Bryan.
