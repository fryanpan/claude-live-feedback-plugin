 ...
 *
 * `HubChromeDeps` is the whole list of what this region may reach. It cannot
...
/** Everything the chrome needs from `bootHub`, and nothing else. */
export interface HubChromeDeps {
...
/** What `bootHub` keeps: the three renders, plus the awareness read the live
 *  wiring drives directly. */
export interface HubChromeRegion {
...
export function createHubChromeRegion(deps: HubChromeDeps): HubChromeRegion {
