 ...
 * subscription order is unchanged. `HubLiveDeps` is the list of what the block
...
export function wireHubLive(deps: HubLiveDeps): void {
  const {
    workspaceId,
    user,
    state,
