...
import type { BoardHandlers } from '../src/hub/board-island.tsx';
import { createHubQueueOpeners } from '../src/hub/hub-queue-open.ts';
 ...
 */
function openers(over: Partial<Parameters<typeof createHubQueueOpeners>[0]> = {}) {
  ...
  const api = createHubQueueOpeners({
    state,
    workspaceId: 'w-1',
    boardHandlers,
    renderDetail,
...
describe('createHubQueueOpeners', () => {
