...
import { goalDetailData } from '../src/hub/goal-detail-island.tsx';
import type { HubActions } from '../src/hub/hub-actions.ts';
import { createHubDetailPanel } from '../src/hub/hub-detail-panel.ts';
import type { HubDiscussion } from '../src/hub/hub-discussion.ts';
import type { HubReviewController } from '../src/hub/hub-review-controller.ts';
import { taskDetailData } from '../src/hub/task-detail-island.tsx';
 ...
 */
function panel(over: Partial<Parameters<typeof createHubDetailPanel>[0]> = {}) {
  const el = mountShell();
  ...
  const api = createHubDetailPanel({
    state,
    ...
    actions: noop as HubActions,
    review: noop as HubReviewController,
    discussion: {
