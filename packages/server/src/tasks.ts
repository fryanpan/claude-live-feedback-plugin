...
export class TaskStore {
  ...
  /** The seat change, forwarded to the board registry that owns it. Kept as
   *  a method so the two agent-side callers read the same as they always
   *  did — they already hold the `state` the registry wants. */
  private assignLead(
