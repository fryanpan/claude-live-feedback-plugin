...
const STOPWORDS = new Set([
  'about', 'actually', 'after', 'again', 'also', 'been', 'before', 'board',
  'could', 'demo', 'does', 'doing', 'file', 'fixed', 'from', 'going', 'gonna',
  'have', 'into', 'just', 'know', 'like', 'last', 'made', 'make', 'makes',
  'more', 'need', 'needs', 'next', 'okay', 'only', 'other', 'over', 'pretty',
  'really', 'right', 'should', 'small', 'some', 'still', 'sure', 'task',
  'that', 'them', 'then', 'there', 'they', 'thing', 'things', 'think', 'this',
  'ticket', 'under', 'very', 'want', 'wants', 'week', 'were', 'what', 'when',
  'where', 'which', 'while', 'will', 'with', 'would', 'yeah', 'your',
]);
