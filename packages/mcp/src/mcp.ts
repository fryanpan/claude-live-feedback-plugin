      ...
      inputSchema: {
        ...
        properties: {
          ...
          order: {
            ...
            items: { type: 'string' },
            description:
              'EVERY goal id at this scope, in the new priority order, highest first. Leaving one out is an error, not a demotion.',
          },
          parent: {
            type: 'string',
            description:
