...
| **Views** | `hub/hub-render.ts`, `hub/hub-detail-render.ts`, `hub/hub-discussion-render.ts`, `hub/hub-review-render.ts`, `editor.ts`, `redline/redline-html.ts` | Data in, elements out. No fetch, no socket, no timers. |
