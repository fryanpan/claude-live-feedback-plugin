...
**Key insight:** the share command is the *publishing* layer in front of review surfaces. It does not replace `attach_markdown` or the widget embed — those continue to be the canonical "make this reviewable" steps. Agents pick whether to publish per share, or stay on the private-by-default flow.
