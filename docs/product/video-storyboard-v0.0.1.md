...
- Two windows side-by-side or quick alt-tab between:
  - **Browser** at `http://mac-mini.tailb53801.ts.net:8788/review/<docId>?as=bryan` — pick a real doc with a paragraph that's worth commenting on. Suggest the README draft itself, or a doc with a small visible imperfection (typo, missing comma, awkward phrasing).
